 ...
 public void edus(){
        try{
            ...
            rs=s.executeQuery("begin "
                             + "dardealta_usuarionombre ("+nombredeusuario+");"
                             + "end;");
           DesktopNotify.showDesktopMessage("Mensaje de Éxito", "Usuario "+nombredeusuario+" ha sido eliminado.", DesktopNotify.SUCCESS);
            ...
            rs=s.executeQuery("begin "
                             + "dardealta_usuario ("+id_deusuario+");"
                             + "end;");
        ...
        {
            DesktopNotify.showDesktopMessage("Mensaje de Fallo", "Fallo en el sistema por el cual no se ha podido dar de alta al usuario.", DesktopNotify.FAIL);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 30, 162, 30));
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 100, 240, 28));

        EL_USID.setBackground(new java.awt.Color(204, 204, 204));
        EL_USID.setForeground(new java.awt.Color(204, 255, 0));
        EL_USID.setText("DAR DE ALTA POR ID");
        ...
        ELUSNO.setText("DAR DE ALTA POR NOMBRE");
        ELUSNO.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ELUSNOActionPerformed(evt);
            }
        });
        getContentPane().add(ELUSNO, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, 180, -1));
